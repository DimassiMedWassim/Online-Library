...
public class UserFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        String loginURL = request.getContextPath() + "/faces/user/Login.xhtml";
        String accueilURL = request.getContextPath() + "/faces/user/accueil.xhtml";
        String panierURL = request.getContextPath() + "/faces/user/panier.xhtml";
        String dcURL = request.getContextPath() + "/faces/user/logout.xhtml";
        ...
        if (user != null && request.getRequestURI().equals(loginURL)) {
            response.sendRedirect(accueilURL);
        } else {
            if (user == null && request.getRequestURI().equals(panierURL)) {
                response.sendRedirect(loginURL);
            } else {
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("UserFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("UserFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("UserFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("UserFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
